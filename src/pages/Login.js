...
import {isAuth, logUser} from "../services/AuthService";

const Login = () => {
    const login = useGoogleLogin({
        onSuccess: tokenResponse => logUser(tokenResponse),
    });
    return(
        ...
        <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
            <div className="text-center">
                <div className="space-y-2">
                    ...
                    <p className="">Pas encore de compte ? <a href="/src/pages/SignUp" className="font-medium text-indigo-600 hover:text-indigo-500">Inscription</a></p>
                </div>
            </div>
            <div className="bg-white shadow p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                <div className="grid grid-cols-3 gap-x-3">
                    <button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100" onClick={() => login()}>
                    ...
                    <button onClick={isAuth} className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                        <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-center">
                <button className="hover:text-indigo-600">Mot de passe oublié ?</button>
            </div>
        </div>
    </main>
    )
